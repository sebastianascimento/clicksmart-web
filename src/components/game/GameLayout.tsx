...
export default function GameLayout({ children }: GameLayoutProps) {
  ...
  const defaultLinkStyle =
    "text-gray-700 hover:text-green-600 transition px-3 py-2 rounded-lg hover:bg-green-50";
  const activeLinkStyle =
    "bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition shadow-sm";
  ...
  const mobileActiveLinkStyle =
    "w-full text-left px-4 py-5 bg-green-50 text-green-700 font-medium text-lg";
              ...
              <ul className="flex flex-col space-y-3">
                <li className="border-b border-green-100">
                  <Link
                    href={`/${locale}`}
                    className={
                      isHomePage ? mobileActiveLinkStyle : mobileLinkStyle
                    }
                  >
                    {t("navigation.home")}
                  </Link>
                ...
                <li className="border-b border-green-100">
                  <Link
                    href={`/${locale}/about`}
                    className={
                      isAboutPage ? mobileActiveLinkStyle : mobileLinkStyle
                    }
                  >
                    {locale === "pt" ? "Sobre" : "About"}
                  </Link>
                ...
                <li className="border-b border-green-100">
                  <Link
                    href={`/${locale}/game`}
                    className={
                      isGamePage ? mobileActiveLinkStyle : mobileLinkStyle
                    }
                  >
                    {locale === "pt" ? "Jogos" : "Games"}
                  </Link>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center md:text-right">
              ...
              <div className="mt-2 flex gap-3 justify-center md:justify-end">
                <span className="text-gray-400 hover:text-green-600 cursor-pointer transition">
                  📱
                </span>
                <span className="text-gray-400 hover:text-green-600 cursor-pointer transition">
                  📧
