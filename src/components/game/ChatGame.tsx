...
export default function ChatGame({
  ...
  // Opções de resposta predefinidas - now using translations
  const responseOptions = {
    defend1: chatT("responseOptions.defend1"),
    defend2: chatT("responseOptions.defend2"),
    join: chatT("responseOptions.join"),
    ignore: chatT("responseOptions.ignore"),
  };
  ...
  useEffect(() => {
    ...
    if (
      nextMessageIndex >= currentScenario.messages.length ||
      waitingForResponse
    ) {
      return;
    }
  ...
  const handleReaction = (
    reaction: "report" | "defend" | "ignore" | "join",
    customText: string
  ) => {
  ...
  const getMessageBorder = (message: Message) => {
    ...
    if (
      message.userReaction === "report" ||
      message.userReaction === "defend"
    ) {
    ...
    <div className="bg-white shadow-md rounded-lg p-4">
      ...
      <div className="flex flex-col h-[750px]">
        ...
        <div className="border rounded-t-lg flex-1 flex flex-col bg-gray-50 relative overflow-hidden">
          ...
          {/* Messages Area - Increased height with flex-1 */}
                  ...
                  >
                    {message.type === "consequence" ? (
                      ...
                      <div className="flex flex-col max-w-[75%]">
                        ...
                        <div
                          className={`rounded-lg py-2 px-4 ${getMessageClass(
                            message
                          )} ${getMessageBorder(message)}`}
                        >
        ...
        {/* Painel de instruções e respostas - Mantendo proporção mas com altura maior */}
        <div className="border-t-0 border rounded-b-lg bg-white">
          {/* Instruções - Now using translation */}
          ...
          {waitingForResponse ? (
            <div className="p-4">
              ...
              <div className="space-y-3">
                ...
                <div
                  onClick={() =>
                    handleReaction("defend", responseOptions.defend1)
                  }
                ...
                <div
                  onClick={() =>
                    handleReaction("defend", responseOptions.defend2)
                  }
                  className="border border-gray-200 hover:bg-gray-100 text-gray-700 py-3 px-4 rounded-lg flex items-center cursor-pointer"
                >
                ...
                <div
                  onClick={() =>
                    handleReaction("ignore", responseOptions.ignore)
                  }
